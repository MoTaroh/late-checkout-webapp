...
const StayPrefectureInput = () => {
  return (
    <div className="flex items-center flex-1 px-4 lg:px-0">
      ...
      <select className="flex-1 px-4 py-2 text-lg font-medium bg-white rounded-md appearance-none cursor-pointer hover:bg-opacity-25 hover:bg-slate-300 lg:font-bold">
