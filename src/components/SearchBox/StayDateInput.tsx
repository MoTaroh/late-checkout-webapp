...
const StayDateInput = () => {
  const { stayDate, handleStayDate, stayCount, handleStayCount } =
    ...
    <div className="flex items-center px-4 py-2 divide-x lg:divide-x-0 lg:px-0 lg:py-0">
      ...
      <div className="flex items-center lg:w-1/4">
        <select
          ...
          className="px-4 py-2 text-lg font-medium bg-white rounded-md appearance-none cursor-pointer hover:bg-opacity-25 hover:bg-slate-300 lg:font-bold"
        >
