...
const HotelListItem = (props: any) => {
    ...
    // クリックイベント
    return (
        <a href={url} rel="noopener noreferrer" target="_blank" className="flex items-center justify-between px-6 py-4 bg-white border border-gray-300 cursor-pointer rounded-xl">
