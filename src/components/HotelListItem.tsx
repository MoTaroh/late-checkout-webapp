    ...
    <div className="flex items-center justify-between p-3 bg-white border border-slate-300 rounded-xl">
      <div className="flex flex-col flex-1 min-w-0">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-center w-8 h-8 bg-slate-200 rounded-full cursor-pointer hover:bg-opacity-25 hover:bg-hotel-green">
            <HeartIcon className="w-6 h-6 text-slate-400 "></HeartIcon>
          </div>
        </div>
        <div>
