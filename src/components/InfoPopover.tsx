    ...
    return (
        <Popover className="relative">
            {({ open }) => (
                <>
                    <Popover.Button
                        className={`${props.color} group rounded-full p-2 inline-flex items-center text-base font-medium hover:bg-gray-800 hover:bg-opacity-25 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75
                        `}
                        >
